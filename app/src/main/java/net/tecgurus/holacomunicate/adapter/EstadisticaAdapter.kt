...
import net.tecgurus.holacomunicate.model.Encuesta
...
class EstadisticaAdapter(val context: Context, val layout: Int, val list: List<Encuesta>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.textocerrar.text = statusEncuestaCerrar

        try {
            if (statusEncuestaCerrar.equals("Cerrar")) {
                vh.textocerrar.setOnClickListener(object : View.OnClickListener {
            ...
            vh.progresoTwo.setOnClickListener(object : View.OnClickListener {
                override fun onClick(position: View?) {
                    showDialog(fullName)
                }
...
class EncuestaViewHolderTwo(view: View) {
    val pregunta: TextView = view.txtPreguntaEs
    ...
    val eliminarTwo: TextView = view.btnEliminarEncuestaTwo

    val progreso: ImageButton = view.btnVerResultados
    val progresoTwo: TextView = view.btnVerResultadosTwo
}