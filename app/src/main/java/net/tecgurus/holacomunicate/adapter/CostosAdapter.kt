 ...
 */
class CostosAdapter(val context: Context, val layout: Int, val list: List<Costos>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val view: View
        val vh: CostosViewHolder
        if (convertView == null) {
            view = parent!!.inflate(layout)
            vh = CostosViewHolder(view)
            view.tag = vh
        } else {
            view = convertView
            vh = view.tag as CostosViewHolder
        }
...
class CostosViewHolder(view: View) {
    val plan: TextView = view.txtTipoPlanMensual
    val costo: TextView = view.txtCostoMensual
    val actualizarCosto: ImageButton = view.btnActualizarCostoMensual
    val actualizarCostoTwo: TextView = view.btnActualizarCostoMensualTwo
