...
import net.tecgurus.holacomunicate.message.ApiClient
import net.tecgurus.holacomunicate.message.ApiInter
import net.tecgurus.holacomunicate.message.Notification
import net.tecgurus.holacomunicate.message.RequestNotificaton
        ...
        try {
            ...
            vh.actividad.setOnClickListener(object : View.OnClickListener {
                ...
                private fun sendNotificationToPatner(token: String) {
                    ...
                    Log.w("RequestNotificaton", requestNotificaton.toString())
                    ...
                    Log.w("responseBodyCall", "responseBodyCall: " + responseBodyCall)

                    responseBodyCall.enqueue(object : Callback<ResponseBody> {
                        override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                            Log.w("onResponse", "Call: " + call.toString() + " Response: " + response.toString())
                        }

                        override fun onFailure(call: Call<ResponseBody>, t: Throwable) {
                            Log.w("onFailure", "Call: " + call.toString() + " Throwable: " + t.toString())
                        }
                    })
                }
            })
