...
import net.tecgurus.holacomunicate.adapter.AProcesoAAdapter
 ...
 */
class ProcesoAFragment : Fragment() {

    private lateinit var adapter: AProcesoAAdapter
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater.inflate(R.layout.fragment_proceso_a, container, false)
    }
