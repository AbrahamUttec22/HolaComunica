 ...
 */
public class PayPalPaymentAnualidadActivity extends AppCompatActivity {
...
*/
    ...
    private void processPayment() {
        PayPalPayment payPalPayment = new PayPalPayment(new BigDecimal(costo), "MXN", "Pago Anual",
